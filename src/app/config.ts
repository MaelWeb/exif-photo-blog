...
export const VERCEL_GIT_COMMIT_SHA_SHORT = VERCEL_GIT_COMMIT_SHA ? VERCEL_GIT_COMMIT_SHA.slice(0, 7) : undefined;
...
export const CUSTOM_NAV_TITLE = process.env.NEXT_PUBLIC_NAV_TITLE;
...
export const IS_META_DESCRIPTION_CONFIGURED = Boolean(process.env.NEXT_PUBLIC_META_DESCRIPTION) || Boolean(NAV_CAPTION);

export const META_DESCRIPTION = process.env.NEXT_PUBLIC_META_DESCRIPTION || NAV_CAPTION || SITE_DOMAIN_SHORT;

export const NAV_TITLE = CUSTOM_NAV_TITLE || SITE_DOMAIN_SHORT || META_TITLE;
...
export const HAS_AWS_S3_STORAGE =
  HAS_AWS_S3_STORAGE_CLIENT && Boolean(process.env.AWS_S3_ACCESS_KEY) && Boolean(process.env.AWS_S3_SECRET_ACCESS_KEY);

// STORAGE: Qiniu Cloud
// Includes separate check for client-side usage, i.e., url construction
export const HAS_QINIU_STORAGE_CLIENT =
  Boolean(process.env.NEXT_PUBLIC_QINIU_BUCKET) &&
  Boolean(process.env.NEXT_PUBLIC_QINIU_REGION) &&
  Boolean(process.env.NEXT_PUBLIC_QINIU_DOMAIN);
export const HAS_QINIU_STORAGE =
  HAS_QINIU_STORAGE_CLIENT && Boolean(process.env.QINIU_ACCESS_KEY) && Boolean(process.env.QINIU_SECRET_KEY);

export const HAS_MULTIPLE_STORAGE_PROVIDERS =
  [HAS_VERCEL_BLOB_STORAGE, HAS_CLOUDFLARE_R2_STORAGE, HAS_AWS_S3_STORAGE, HAS_QINIU_STORAGE].filter(Boolean).length >
  1;
...
export const CATEGORY_VISIBILITY = getOrderedCategoriesFromString(process.env.NEXT_PUBLIC_CATEGORY_VISIBILITY);
export const SHOW_RECENTS = CATEGORY_VISIBILITY.includes('recents');
export const IS_RECENTS_FIRST = CATEGORY_VISIBILITY[0] === 'recents';
export const SHOW_YEARS = CATEGORY_VISIBILITY.includes('years');
...
export const SHOW_CATEGORY_IMAGE_HOVERS = process.env.NEXT_PUBLIC_HIDE_CATEGORY_IMAGE_HOVERS !== '1';
export const COLLAPSE_SIDEBAR_CATEGORIES = process.env.NEXT_PUBLIC_EXHAUSTIVE_SIDEBAR_CATEGORIES !== '1';
export const HIDE_TAGS_WITH_ONE_PHOTO = process.env.NEXT_PUBLIC_HIDE_TAGS_WITH_ONE_PHOTO === '1';

// SORT

export const USER_DEFAULT_SORT_BY = getSortByFromString(process.env.NEXT_PUBLIC_DEFAULT_SORT);
export const USER_DEFAULT_SORT_WITH_PRIORITY = process.env.NEXT_PUBLIC_PRIORITY_BASED_SORTING === '1';
export const USER_DEFAULT_SORT_OPTIONS = {
  sortBy: USER_DEFAULT_SORT_BY,
  sortWithPriority: USER_DEFAULT_SORT_WITH_PRIORITY,
};
export const SHOW_SORT_CONTROL = process.env.NEXT_PUBLIC_SHOW_SORT_CONTROL === '1';

// DISPLAY

export const SHOW_KEYBOARD_SHORTCUT_TOOLTIPS = process.env.NEXT_PUBLIC_HIDE_KEYBOARD_SHORTCUT_TOOLTIPS !== '1';
...
export const SITE_FEEDS_ENABLED = process.env.NEXT_PUBLIC_SITE_FEEDS === '1';
export const OG_TEXT_BOTTOM_ALIGNMENT = (process.env.NEXT_PUBLIC_OG_TEXT_ALIGNMENT ?? '').toUpperCase() === 'BOTTOM';
...
export const APP_CONFIGURATION = {
  ...
  // Internal
  areInternalToolsEnabled: ADMIN_DEBUG_TOOLS_ENABLED || ADMIN_DB_OPTIMIZE_ENABLED || ADMIN_SQL_DEBUG_ENABLED,
